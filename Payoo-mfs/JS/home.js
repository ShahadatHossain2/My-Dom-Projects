...
//     document.getElementById('add-money-button').removeAttribute('disabled')
//     console.log('add clicked')
// })
// document.getElementById('cash-out-enable').addEventListener('click', function() {
//     document.getElementById('cash-out-button').removeAttribute('disabled')
// })
...
//     const outMoney = document.getElementById('amountAdd').value
//     const pin = document.getElementById('pin').value
